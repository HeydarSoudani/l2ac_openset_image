...
if __name__ == '__main__':
  ...
  if args.dataset == 'mnist':
    train_data = read_csv(os.path.join(args.data_path, "train.csv"), sep=',', header=None).values
    test_data = read_csv(os.path.join(args.data_path, "test.csv"), sep=',', header=None).values
